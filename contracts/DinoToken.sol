...
contract DinoToken is ERC721Enumerable, Ownable {
    ...
    // withdraw addresses
    address t1 = 0xEBB9603d319a8A55C05DE2dF3FaF0deb085372E6;

    constructor(
        string memory baseURI
    ) ERC721("Dapper Dinos", "DINO") {
        setBaseURI(baseURI);
        //mint to team
    ...
    function mint(
        ...
        require(
            balanceOf(msg.sender) < 101,
            "Too many tokens owned to mint more"
        );

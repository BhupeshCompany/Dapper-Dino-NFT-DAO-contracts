...
contract LiquidityMiningManager is TokenSaver {
    ...
    function addPool(address _poolContract, uint256 _weight) external onlyGov {
        ...
        require(
            ...
            "LiquidityMiningManager.addPool: Max amount of pools reached"
        );
        // add pool
        pools.push(
        ...
        // Set weight percentage of pool in Utility contract
        // uint256 weightPercent = (_weight * 100)/(1 * 10**18);
        // IUtilityManager(utilityManager).updateWeight(pools.length-1,weightPercent);
        ...
        onlyGov
    {
        ...
        // Set weight percentage of pool in Utility contract
        // uint256 weightPercent = (_newWeight * 100)/(1 * 10**18);
        // IUtilityManager(utilityManager).updateWeight(_poolId,weightPercent);
    ...
    function distributeRewards() public onlyRewardDistributor {
        ...
        for (uint256 i = 0; i < pools.length; i++) {
            ...
            (bool success,) = address(pool.poolContract).call(
                abi.encodeWithSelector(
            ...
            if (success) {
                ...
                IUtilityManager(utilityManager).updatePendingRewards(
                    poolRewardAmount,
                    0
                );
            }

...
interface IRewardsPool {
    function addReward(address _receiver, uint256 _amount) external;
}
...
interface IUtilityManager {
    ...
    function updateStakedAmount(uint256 _amount) external;

    function updateClaimedAmount(uint256 _amount) external;

    function updateUnclaimedAmount(uint256 _amount, uint256 _operation)
        external;

    function updateTotalValueLockedAmount(uint256 _amount, uint256 _operation)
        external;
...
contract TimeLockPool is BasePool, ITimeLockPool {
    ...
    function setMaximumBonus(uint256 _maximumBonus) external {
        require(
            owner == msg.sender,
            "Access denied, only contract owner allowed!"
        );
        require(
    ...
    function setMaximumLockDuration(uint256 _maximumLockDuration) external {
        require(
            owner == msg.sender,
            "Access denied, only contract owner allowed!"
        );
    ...
    function setMaximumNftStakingAllowed(uint256 _maximumNftStakingAllowed)
        external
    {
        require(
            owner == msg.sender,
    ...
    function _deposit(
        ...
        require(tokenOwner == msg.sender, "Caller is not owner of NFT!");
    ...
    function deposit(
        ...
        require(
            ...
            "No. of NFT to be staked should be in the limit set!"
        );
    ...
    function _withdraw(uint256 _depositId, address _receiver) internal {
    ...
    function withdraw(uint256[] memory _depositIds, address _receiver)
        external
    {
...
contract DinoPool is TimeLockPool {
    constructor(
        string memory _name,
        string memory _symbol,
        address _depositToken,
